					...
					<t:div styleClass="content_pad">
						...
						<h:form enctype="UTF-8" acceptcharset="UTF-8">
							<h:panelGrid columns="2" columnClasses="highlight">
								...
								<h:outputText value="Phonetic" styleClass="font2" />
								<h:inputText id="ph" value="#{BrainSession.currentItem.comment}" size="40" />
								<h:outputText value="Answers" styleClass="font2" />
								<h:panelGroup>
									<t:dataTable styleClass="naked" id="alist" value="#{BrainSession.currentItem.answers}" var="answer" rows="#{BrainSession.numRows}">
										<h:column>
								...
								<h:outputText value="" />
								<h:panelGroup>
									<h:commandButton styleClass="font5 naked c4" value=">OK" action="#{BrainSession.currentItem.saveAction}" />
