...
public interface BrainDB {
	...
	IUserLesson subscribeLesson(User user, Lesson lesson) throws DBException;

	void unsubscribeLesson(User user, IUserLesson lesson) throws DBException;
	...
	Vector<IUserLesson> getUserLessons(User user) throws DBException;

	Vector<IUserLesson> getUserLessons(Lesson lesson) throws DBException;

	Vector<IUserLesson> getUserLessons(CombinedUserLesson combinedUserLesson) throws DBException;
	...
	UserItem getNextUserItem(IUserLesson userLesson) throws DBException;
	...
	int getUserLessonAvailable(IUserLesson lesson) throws DBException;

	int getUserLessonAvailable(long userLessonId);

	IUserLesson getUserLesson(User user, long userLessonId) throws DBException;

	IUserLesson getUserLessonByLessonID(User user, long lid) throws DBException;
	...
	// void activateUserItem(IUserLesson userLesson) throws DBException;

	void activateUserItemExp(IUserLesson userLesson) throws DBException;

	Vector<Answer> getAnswers(long itemId) throws DBException;

	int getUserScore(User user) throws DBException;

	// int getUserLessonScore(IUserLesson userLesson);

	void storeUserScore(User user, int score) throws DBException;

	void getUserLessonLevels(IUserLesson parentUserLesson) throws DBException;
	...
	FacebookUser getFacebookUser(long facebookID) throws DBException;

	void fb_linkUser(User user, long facebookId) throws DBException;
