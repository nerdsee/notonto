...
public class UserItem extends AbstractContent{
	...
	public IUserLesson getUserLesson() throws DBException {
		IUserLesson userLesson=null;
		try {
			userLesson = BrainSystem.getBrainSystem().getBrainSession().getCurrentUserLesson();
		} catch(Exception e) {
			User cu = BrainSystem.getBrainSystem().getBrainSession().getCurrentUser();
	...
	public IUserLesson getUserLesson(User user) throws DBException {
		IUserLesson userLesson=null;
		try {
	...
	public void forceAnswer() throws DBException {
		...
		IUserLesson userLesson = getUserLesson();
	...
	private void forgotten(User user) throws DBException {
		IUserLesson userLesson = getUserLesson(user);
		forgotten(userLesson);
	}

	private void forgotten(IUserLesson userLesson) throws DBException {
		wrong++;
	...
	private void learned(IUserLesson userLesson) throws DBException {
